...
// build Initialize
void StructCircularLinkedList::Initialize_Empty() 
{
    this->sizearray = 0;
}
void StructCircularLinkedList::Initialize_Random()
{
    this->sizearray = Rand(2, this->maxsize - 1);
    for(int i = 0; i < this->sizearray; i++) elements[i] = Rand(0, 999);
}
void StructCircularLinkedList::Initialize_Manual(std::vector<int> arr) 
{
    this->sizearray = (arr.size() < this->maxsize ? arr.size() : this->maxsize);
    for(int i = 0; i < this->sizearray; i++) 
        this->elements[i] = arr[i];
}
int StructCircularLinkedList::Initialize_ExternalFile(std::string filename) 
{
...
// build Insert
int StructCircularLinkedList::Insert_First(int value) 
{
...
int StructCircularLinkedList::Insert_Last(int value)
{
    if (sizearray == maxsize) {
        std::cout << "Limited Data. Can't add more\n";
        return -1;
...
int StructCircularLinkedList::Insert_Manual(int pos, int value) 
{
    if (sizearray == maxsize) {
        std::cout << "Limited Data. Can't add more\n";
        return -1;
...
// build Delete
void StructCircularLinkedList::Del_First()
{
    if (sizearray == 0) return;
    std::rotate(elements.begin(), elements.begin() + 1, elements.begin() + sizearray);
    sizearray--;
}
void StructCircularLinkedList::Del_Last()
{
    if (sizearray == 0) return;
    sizearray--;
}
int StructCircularLinkedList::Del_Manual(int pos)
{
...
// build Update
int StructCircularLinkedList::Update(int pos, int value) 
{
...
// build Search
int StructCircularLinkedList::Search(int value) 
{
